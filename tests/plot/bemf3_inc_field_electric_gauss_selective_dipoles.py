...
def bemf3_inc_field_electric_gauss_selective_dipoles(strdipolePplus = None,strdipolePminus = None,strdipolesig = None,strdipoleCurrent = None,P = None,t = None,Center = None,dipoleClusterCenter = None,gaussRadius = None): 
...
#trianglesToSubdiv(trianglesToSubdiv_temp{1}) = true;
    ...
    Epri = np.zeros((t.shape[1-1],3))
    Ppri = np.zeros((t.shape[1-1],1))
