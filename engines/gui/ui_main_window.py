...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setLayout(5, QFormLayout.ItemRole.LabelRole, self.verticalLayout_10)

        self.csf = QCheckBox(self.groupBox)
        self.csf.setObjectName(u"csf")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.csf)

        self.Bone = QCheckBox(self.groupBox)
        self.Bone.setObjectName(u"Bone")

        self.formLayout.setWidget(0, QFormLayout.ItemRole.LabelRole, self.Bone)

        self.Cerebellum = QCheckBox(self.groupBox)
        self.Cerebellum.setObjectName(u"Cerebellum")

        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.Cerebellum)

        self.gm = QCheckBox(self.groupBox)
        self.gm.setObjectName(u"gm")

        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.gm)

        self.Skin = QCheckBox(self.groupBox)
        self.Skin.setObjectName(u"Skin")

        self.formLayout.setWidget(2, QFormLayout.ItemRole.LabelRole, self.Skin)

        self.Ventricles = QCheckBox(self.groupBox)
        self.Ventricles.setObjectName(u"Ventricles")

        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.Ventricles)

        self.wm = QCheckBox(self.groupBox)
        self.wm.setObjectName(u"wm")

        self.formLayout.setWidget(3, QFormLayout.ItemRole.LabelRole, self.wm)

        self.ApplyHeadModel = QPushButton(self.groupBox)
        self.ApplyHeadModel.setObjectName(u"ApplyHeadModel")

        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.ApplyHeadModel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"X Position (m)", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Y Position (m)", None))
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"Z Position (m)", None))
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"White Matter Disatnce", None))
