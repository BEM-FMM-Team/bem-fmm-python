...
def bemf3_inc_field_electric(strcoil = None,Points = None,dIdt = None,mu0 = None):
    """
    ...
    N = Points.shape[0]
    segvector = np.multiply((strcoil.Pwire[strcoil.Ewire[ :,1 ],:] - strcoil.Pwire(strcoil.Ewire(:,1),:)),np.tile(strcoil.Swire,(1,3)))
