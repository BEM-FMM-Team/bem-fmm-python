...
def  bemf4_surface_field_electric_subdiv(c, P, t, Area, mode, modeArg, prec)
    ## Input parsing
    if(nargin < 4)
    ...
    if      gauss == 0:
        ...
        raise RuntimeError('Invalid Gaussian subdivision parameter');
    ...
    [P, E] = bemf4_surface_field_electric_plain(c_subdiv, Center_subdiv, Area_subdiv, prec);
