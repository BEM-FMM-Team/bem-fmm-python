function [Epri, Ppri] = bemf3_inc_field_electric_gauss_selective_dipoles(SourceDipole, P, t, Center, dipoleClusterCenter, gaussRadius)
...
if any(~trianglesToSubdiv)
    ...
    fprintf("skipping primary at triangles which do not need subdiv.")
end
