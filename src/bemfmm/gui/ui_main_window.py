...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSave_Coil_Config.setObjectName("actionSave_Coil_Config")
        ...
        self.actionSphere_3L.setObjectName("actionSphere_3L")
        self.actionPlot = QAction(MainWindow)
        self.actionPlot.setObjectName("actionPlot")
        self.actionDefault_TMS = QAction(MainWindow)
        self.actionDefault_TMS.setObjectName("actionDefault_TMS")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLoad_Coil_Config.setText(
            QCoreApplication.translate("MainWindow", "Open Configuration", None)
        )
        self.actionSave_Coil_Config.setText(
        ...
        self.action3D_viewer_Help.setText(
            QCoreApplication.translate("MainWindow", "3D viewer Help", None)
        )
        ...
        self.actionSphere_3L.setText(
            QCoreApplication.translate("MainWindow", "Sphere 3L", None)
        )
        self.actionPlot.setText(QCoreApplication.translate("MainWindow", "Plot", None))
        self.actionDefault_TMS.setText(
            QCoreApplication.translate("MainWindow", "Default TMS", None)
        )
        ...
        self.groupBox.setTitle(
            QCoreApplication.translate("MainWindow", "Head Model Opacity", None)
        )
        ...
        self.groupBox_4.setTitle(
            QCoreApplication.translate("MainWindow", "Move Slice Planes", None)
        )
