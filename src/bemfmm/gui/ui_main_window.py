...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NameEntry = QLineEdit(self.groupBox_3)
        self.NameEntry.setObjectName(u"NameEntry")

        self.horizontalLayout_7.addWidget(self.NameEntry)
        ...
        self.SaveRun.setObjectName(u"SaveRun")
        ...
        self.verticalLayout_9.addWidget(self.Load)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SaveRun.setText(QCoreApplication.translate("MainWindow", u"SaveRun", None))
